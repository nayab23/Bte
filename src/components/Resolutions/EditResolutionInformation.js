...
class EditResolutionInformation extends Component {
    render() {
        return (
            <div>
          ...
          <div className="tile tile--2 tile--wallet">
            ...
            <section className="add-resolutions" data-tab="get-paid">
              <form action="#" method="post" encType="multipart/form-data">
                <input type="hidden" name="_token" value="orUewQJWMEb8XMn8aQwwdGhgMfh7MET3NGGkpOSC" /> <input
                  type="hidden" value="32" name="id" />
                <div className="row justify-content-center">
                  <div className="col-12">
                    ...
                    <div className="add-resolutions__section">
                      ...
                      <p> Tell us more about your business and the whole project overall. (2000 Caracters max) Tell us
                        more about your business and the whole project overall. (2000 Caracters max) Tell us more about
                        your business and the whole project overall. (2000 Caracters max) Tell us more about your
                        business and the whole project overall. (2000 Caracters max)</p>
                    ...
                    <div
                      ...
                      <div className="col-12 col-md-10 col-lg-7 order-1">
                        ...
                        <label className="input__wrapper">
                          <input type="text" className="input" placeholder="Antivirus  not functioning" name="title"
                            value="Test Feb 4" required />
                        ...
                        <label className="input__wrapper mb-2">
                          <div className="cover-image cover-image--md-6" id="cover_image_0" style={{display: "none"}}>
                          </div>
                      ...
                      <div className="col-12 col-lg-4 order-0 order-lg-1 resolution__sidebar">
                        <div>
                          ...
                          <label className="input__wrapper mt-3">
                            <div className="ui dropdown selection" tabIndex={0}><select name="url_type"
                                id="add-resolution-privacy" required>
                                <option value="" selected disabled>Select the privacy level</option>
                                <option value="public" selected>Free to public</option>
                                <option value="private">Available by url</option>


                              </select><i className="dropdown icon"></i>
                              <div className="text">Free to public</div>
                              <div className="menu" tabIndex={-1}>
                                <div className="item active selected" data-value="public">Free to public</div>
                                <div className="item" data-value="private">Available by url</div>
                              </div>
                            </div>
                        ...
                        <div className="contract-info-block mt-5">
                          ...
                          <div
                            ...
                            <span>$</span><span className="js-edit-target-amount"></span><span>/ hour</span>
                            <label className="input__wrapper mb-0 hide">
                              <input type="text" className="input" placeholder="Hourly rate" id="contract_rate" />
                              <input type="hidden" name="rate" value="" id="rate" />
                            </label>
                          </div>
                          <button type="button" className="button--no-style button--edit js-edit-button">
                            <img src="/public/app_assets/img/pencil.svg" alt="edit button" />
                            <span>Edit</span>
                          </button>
                        </div>
                      </div>
                    ...
                    <div
                      ...
                      <div className="col-12 col-md-10 col-lg-7">
                        ...
                        Describe how you solved this ticket problem. Make sure the description is detailed showing step
                        after step.
                        <p></p>
                        <label className="input__wrapper mb-2">
                          <textarea className="input height-150" name="description"
                            maxLength={2000}>Tell us more about your business and the whole project overall. (2000 Caracters max)  Tell us more about your business and the whole project overall. (2000 Caracters max)  Tell us more about your business and the whole project overall. (2000 Caracters max)  Tell us more about your business and the whole project overall. (2000 Caracters max)</textarea>
                    ...
                    <div
                      ...
                      <div className="col-12">
                        ...
                        <h2 className="post-ticket__subtitle">
                      ...
                      <div className="col-12 col-md-9 col-lg-6 mt-4 screens">
                        <span className="button--no-style button--screenshot button--screenshot-remove--shot"
                          data-screen="screen1" data-id="105"
                          style={{zIndex: 1, marginLeft: "89%", position: "absolute", cursor: "pointer", marginTop: "-8px"}}></span>
                        <div className="screenshot-block screenshot-block--horizontal">

                          <label className="input__wrapper mb-2">

                            <div className="cover-image" id="image-holder-screenshot_0" style={{display: "none"}}>
                            </div>

                            <div className="cover-image" id="image-holder2_shot_0">
                              <img src="/public/app_assets/img/photo-camera-1.svg" alt="" />
                              <input type="file" className="hide fileUpload2" id="0" name="screenshot0" />
                              <input type="hidden" name="screen1" value="105" />
                            </div>
                          </label>
                          <label className="input__wrapper mb-2">
                            <textarea className="input height-115 ta-no-resize" name="screendescription0"
                              maxLength={2000}> Tell us more about your business and the whole project overall. (2000 Caracters max)  Tell us more about your business and the whole project overall. (2000 Caracters max)  Tell us more about your business and the whole project overall. (2000 Caracters max)  Tell us more about your business and the whole project overall. (2000 Caracters max) </textarea>
                            <p className="input__notification">Text is required</p>
                          </label>
                        </div>
                      ...
                      <div className="col-12">
                        ...
                        <div className="ticket__description-text opened-ticket__description-text pl-0 mt-4">
                          ...
                          <label className="fileupload__button mt-3"> <span>+</span>
                            ...
                            <input type="file" name="attachments[]" multiple className="visually-hidden" id="file" />
                          </label>
...
export default EditResolutionInformation;