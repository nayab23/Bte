...
function Paymentmethods() {
    ...
    <main className="main-content main-content--dashboard">
        <div className="container container-fluid-small">
            <div className="row justify-content-center">
                ...
                <div className="col-12 col-lg-4 order-1 d-none d-md-block">
                    ...
                    <div className="tile tile--2 tile--wallet">
                        <div className="ticket-header">
                            <ul className="ticket-header__list">
                                ...
                                <li className="ticket-header__list-item d-none d-md-block " data-tab="get-paid">
                                    <a href="#">
                                        Get Paid
                                    </a>
                                </li>
                                <li className="ticket-header__list-item d-none d-md-block ticket-header__list-item--active" data-tab="in-progress">
                                    <a href="#">
                                        In progress
                                    </a>
                                </li>
			    ...
			    <p className="d-none wallet__amount_get">300</p>
                        ...
                        <section className="ticket-body wallet-section wallet-section--progress hide" data-tab="in-progress">
 			...
 			<li>
                        ...
                        <section className="ticket-body wallet-section wallet-section--progress hide" data-tab="payment-history">
                                <ul className="wallet-tickets">
 ...
 <section className="ticket-body wallet-section wallet-section--progress hide" data-tab="payment-withdrawal">
...
> Download Pdf</button>
                        ...
                        <section className="ticket-body wallet-section wallet-section--payment-methods hide" data-tab="payment-methods">
                            <div className="payment-methods__section">
                                <p className="payment-methods__add-text">
                                    Add a Payment method so you'll be able to receive your funds from BTE
                                </p>
