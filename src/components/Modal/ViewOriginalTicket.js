...
class ViewOriginalTicket extends Component {
    ...
    render() {
        return (
            <div>
            <a href="#" class="contract-orignal-ticket" style={{marginTop: "3px"}} onClick={this.toggle(9)}>View Original Ticket</a>
                <MDBContainer className="view-original-ticket-modal" >
                    <MDBModal style={{display:"flex"}} isOpen={this.state.modal9} toggle={this.toggle(9)} backdrop={true} position="left">
                        <MDBModalHeader toggle={this.toggle(9)} className="modal-ticket-header"></MDBModalHeader>
                            <MDBModalBody>
                            <h3 class="hire-ticket__name" style={{marginLeft: "10px"}}>Tickets title</h3>
                            <h2 className="ticket__name" style={{fontSize: "16px"}}>Full Stack Developer, Databases, Web Architecture &amp; Storage</h2>
...
export default ViewOriginalTicket;