            ...
            <div className="edit-info" onClick={this.toggle(9)} >
                ...
                <MDBContainer>
                    <MDBModal  className="center--modal"  style={{display:"flex"}} isOpen={this.state.modal9} toggle={this.toggle(9)} backdrop={true} fullHeight position="right">
                        <MDBModalHeader toggle={this.toggle(9)} className="modal-ticket-header"><h3 class="hire-ticket__name">Edit Project</h3></MDBModalHeader>
                            <MDBModalBody className="body-scroll">
                            <div className="mb--style">
                            <form onSubmit={this.handleSubmit} className="mb-style hide edit-info-form " id="Registeruser">
                            <h3 class="hire-ticket__name ">Add Your Info</h3>
                            <div className="row">
                                <div className="col-12 col-md-12 ">
                                    <p className="input__title input__title--half">Title</p>
                            ...
                            <br />
                            <h3 class="hire-ticket__name  mb-3">Add Video</h3>
                            <div className="row">
                                <div className="col-12 col-md-12 ">
                                    <label className="input__wrapper input__wrapper--half mt-4">
                                    <a href="#" className="video-box venobox wow slideInUp " data-wow-duration="3s" data-wow-delay="2s" data-vbtype="video"> 
                                       ...
                                       <label for="upload-picture" class="hire-ticket__name ml-5" ><span style={{textDecoration: "underline"}}>Upload Video</span></label>
                            ...
                            <br />
                            <h3 class="hire-ticket__name  mb-3 mt-3">Add Your Profile picture</h3>
                            <div className="row">
                                <div className="col-12 col-md-12 ">
                                    <label className="input__wrapper input__wrapper--half ">
                                       <label for="upload-picture" class="hire-ticket__name" ><span style={{textDecoration: "underline"}}>Upload picture</span></label>
