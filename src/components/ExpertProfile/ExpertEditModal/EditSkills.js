...
class EditSkills extends Component {
    ...
    render() {
        ...
        return (
            <div>
            <div className="edit-info" style={{marginRight: "42px", marginTop: "-24px"}} onClick={this.toggle(9)} >
            ...
            <MDBContainer className="center--modal" >
                <MDBModal className="center--modal mb-0 " style={{display:"flex"}} isOpen={this.state.modal9} position="right" toggle={this.toggle(9)} backdrop={true}>
                    <MDBModalHeader toggle={this.toggle(9)} className="profile-modal-header quali-head">
                        ...
                        <form onSubmit={this.handleSubmit} className="mb-style edit-info-form " id="Registeruser"> {/*===================================== skills ==================================== */}
                            ...
                            <div className="row">
                                ...
                                <h3 className="filter__section-label">Skills</h3> 
                                    <Select
                                        ...
                                        options={skills}
                                        isMulti
                                        defaultValue={[skills[4], skills[5]]}
