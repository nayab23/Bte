...
class AddProjectDetail extends Component {
    ...
    render() {
        ...
        return (
            ...
            <div className="profile-add-social-links"  onClick={this.toggle(9)} style={{cursor:"pointer"}}>
                <h3 className="mt-1 ml-3">Add more project</h3>
                         ...
                         <MDBModalHeader toggle={this.toggle(9)} className="modal-ticket-header"></MDBModalHeader>
                            ...
                            <MDBModalFooter>
                                <div className="contract-details">
                                    <button toggle={this.toggle(9)} style={{ width: "318px", color: "#ffffff"}}
                                    type="button" className="button-con d-md-inline  ">
                                    <span style={{color: "#ffffff"}}>Close</span></button>
