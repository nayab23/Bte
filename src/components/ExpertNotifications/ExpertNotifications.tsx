...
<div className="container container-fluid-small">
        <div className="row justify-content-center">
            ...
            <div className="col-12 col-lg-8 order-0 order-lg-1 search-box-wrapper"> 
            </div>
                             ...
                             <li className="notifications__list-item">
                                <div className="notifications__content">
                                    <div className="notifications__main">
                                       ...
                                       <p className="notifications__main-title notifications__main-title--italic" style={{cursor: "pointer"}} >
                 Ticket Invitation
                 </p>
